    ...
    <>
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          <Link to="/">
            <img src="/logo.png" alt="Resumint" className="h-11 w-auto" />
          </Link>
        ...
        <div
          ...
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center hover:text-green-300 transition text-white rounded-md flex">
            <CircleX />
          </button>
        </div>
