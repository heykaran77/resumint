  ...
  const cardsData = [
    {
      ...
      date: "April 20, 2025",
      description:
        "Resumint made creating my résumé effortless — clean, quick, and AI-smart.",
    },
    {
      image:
        "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200",
      name: "Kushal",
      handle: "@kushal.designs",
      date: "May 10, 2025",
      description:
        "Loved how intuitive Resumint feels — polished results in minutes.",
    },
    {
      image:
      ...
      date: "June 5, 2025",
      description:
        "Resumint helped me build a professional résumé that actually stands out.",
    },
    {
      image:
      ...
      date: "June 18, 2025",
      description:
        "We used Resumint together — the templates and AI suggestions were spot on.",
    },
  ];
    ...
    <div
      ...
      <div className="flex items-center space-x-2.5 border border-green-500/30 rounded-full bg-green-500/10 p-1 text-sm text-green-800">
        <div className="bg-green-300 border border-green-500/30 rounded-2xl px-3 py-1 flex items-center gap-2">
          <span>
            <BookUserIcon width={16} />
          </span>
          <p>Testimonials</p>
        </div>
        <p className="pr-3">What professionals say</p>
      </div>
      {/* Title */}
      <Title
        title="Real Stories. Real Results."
        description="Professionals across industries use Resumint to create résumés that stand out"
      />
      {/* Animation */}
      <style>{`
